...
export const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative w-full h-[600px] bg-black text-white overflow-hidden rounded-2xl my-6">
      {/* Main container with space for content */}
      <div className="relative z-20 w-full h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col justify-center">

        <motion.div
          variants={containerVariants}
          initial="hidden"
          animate="visible"
          className="w-full z-200 top-[30%] relative hidden sm:block"
        >
        ...
        <motion.div
          ...
          initial="hidden"
          animate="visible"
          className="relative z-30 flex flex-col items-center justify-center text-center max-w-4xl mx-auto h-full"
        >            <ElasticHueSlider
              value={lightningHue}
...
export const HeroBackground: React.FC = () => {
  return (
    <div className="fixed inset-0 z-[-1] bg-black text-white overflow-hidden pointer-events-none">
      <motion.div
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ duration: 1 }}
